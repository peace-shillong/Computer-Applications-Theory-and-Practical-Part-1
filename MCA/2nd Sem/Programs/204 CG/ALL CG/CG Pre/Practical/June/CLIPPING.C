...
void main()
{
	...
	//Locker
	draw_line(190,200,210,200);
	draw_line(190,201,210,201);
	draw_line(205,200,205,215);
	draw_line(206,200,206,215);
	draw_line(198,205,198,210);
	...
	draw_line(xin,yin,xout,yin);
	draw_line(xin,yin,xin,yout);
	draw_line(xin,yout,xout,yout);
	draw_line(xout,yout,xout,yin);
