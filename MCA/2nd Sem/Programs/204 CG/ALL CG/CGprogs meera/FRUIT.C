...
void main()
{
	...
	//leave
	curve1(208,200,280,210,10,10,10,100);
	curve1(208,200,240,210,10,40,40,40);
	curve1(208,200,280,210,100,100,200,100);
	...
	//mango
	curve1(190,450,208,240,50,600,-100,40);
	curve1(190,450,208,240,40,-700,300,50);
	color(200,300,YELLOW,WHITE);
	getch();
	closegraph();
}
