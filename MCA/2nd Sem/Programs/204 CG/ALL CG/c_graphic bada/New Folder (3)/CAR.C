...
void main()
{
	...
	color(71,386,7,WHITE);
	color(171,386,7,WHITE);
	color(100,300,6,WHITE);
	x[0]=70;y[0]=280;
	x[1]=170;y[1]=280;
	x[2]=70;y[2]=330;
	x[3]=170;y[3]=330;
...
void translate(int x[],int y[])
{
	...
	for(i = 0;i<400;i++)
	{
		...
		color(x[8],y[8],BLACK,WHITE);
		color(x[9],y[9],BLACK,WHITE);
		color(x[10],y[10],BLACK,WHITE);
