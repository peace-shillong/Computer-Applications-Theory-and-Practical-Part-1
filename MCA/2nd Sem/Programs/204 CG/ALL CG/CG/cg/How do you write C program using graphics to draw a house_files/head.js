if (window.jQuery) {
    // ensure any PREVIOUS jQuery scripts are relegated to $_old
    window.$_old = jQuery.noConflict();
}
...
$('[track]').live('click', function(){ track_click($(this).attr('track'), $(this).attr('sub_referrer')); });
...
if(typeof links_google_window_target === 'undefined')
{
	var links_google_window_target = '_blank';
}
...
var links_google_obj = function() {
	...
	var inject_ad_info_link = function(type, el) {
		...
		if(atag.length == 0 && obj.meta[type] && obj.add_adinfo) {
			var infolink = document.createElement('a');
			infolink.className = 'adinfo';
			infolink.href = obj.meta[type]['feedback_url'];
			infolink.innerHTML = 'Ads';
			// Look for links_google_new_window variable to open link in new window
			if(typeof links_google_new_window !== 'undefined')
			{
			    infolink.setAttribute('target', '_blank');
			}
			el.appendChild(infolink);
		} else if(type == 'afs' && obj.add_adinfo) {
		...
		} else if((type == 'afc' || type == 'afcimages') && obj.add_adinfo) {
			var atag = find_by_class(el, 'div', 'adinfo');
			if(atag.length == 0) {
				var infolink = document.createElement('div');
				infolink.className = 'adinfo';
	...
	var get_template = function(type) {
		if(obj.templates[type]) {
			return obj.templates[type];
		}

		return obj.templates['default'];
	}
	...
	var get_unit_html = function(type, unit, n) {
		...
		if(type=='radlinks'){
			...
			if(typeof unit.img != 'undefined') {
				string = string.replace('##IMAGE##', unit.img);
			}
			if(typeof unit.track_link !== 'undefined'){
				string = string.replace('##TRACK_URL##', unit.track_link);
			}else{
				string = string.replace('##TRACK_URL##', unit.url);
			}
			string = string.replace('##DISPLAY_URL##', unit.visible_url);
			string = string.replace('##DESC_1##', unit.line2);
			if(typeof unit.line3!="undefined"){
	...
	var adsnip_click = function(el, type, unit) {
		if(typeof Adsnip !== 'undefined') {
			...
			//});
			if(Adsnip.config.click_tracking !== false){
	...
	var get_WSS_tracking = function(type, index){
		...
		if(obj.page_type == "ra_topic") {
			...
			lpos = "NotLgd_" + ((obj.page_type=="wa_question_answered")?"Ans":"UnAns");
		}
		var wss = lid + "/" + lpos;
		return wss;
	}
	...
	return {
		templates: {
			// ##HEADLINE##, ##DISPLAY_URL##, ##DESC_1## ##DESC_2##
			 'two_line': '<div class="two_line"><a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\'" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a><span class="desc">##DESC_1## ##DESC_2##</span></div>',
			 'two_line_description_clickable': '<div class="two_line_description_clickable"><a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\'" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a><div class="two_line"><a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\'" target="'+links_google_window_target+'"><span class="desc">##DESC_1## ##DESC_2##</span></a></div>',

			// ##HEADLINE##
		     'radlinks':'<div class="radlink"><a track="##WSS##" href="##URL##" class="headline site adUnitLink" target="'+links_google_window_target+'">##HEADLINE##</a></div>',

		    // ##HEADLINE##, ##DESC_1## ##DESC_2##, ##DISPLAY_URL##
		     'three_line':'<a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\'" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><span class="desc">##DESC_1## ##DESC_2##</span><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a></div>',
		     'three_line_description_clickable':'<div class="three_line_description_clickable"><a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\'" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\'" target="'+links_google_window_target+'"><span class="desc">##DESC_1## ##DESC_2##</span></a><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a></div>',
		     // ##HEADLINE##, ##DISPLAY_URL##, ##DESC_1## ##DESC_2##
		     'three_line_alt1':'<div class="three_line_alt1"><a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\'" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a><span class="desc">##DESC_1## ##DESC_2##</span></div>',
			'three_line_alt2':'<div class="three_line_alt2"><div class="headline-wrap"><a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\'" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a></div><div class="site-wrap"><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a></div><div class="desc-wrap"><span class="desc">##DESC_1## ##DESC_2##</span></div><div class="arrow-wrap"><a track="##WSS##" href="##URL##" class="arrow-btn adUnitLink" target="'+links_google_window_target+'"></a></div></div>',
			'three_line_alt2b':'<div class="three_line_alt2b"><div class="headline-wrap"><a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\'" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a></div><div class="site-wrap"><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a></div><div class="desc-wrap"><span class="desc">##DESC_1## ##DESC_2##</span></div></div>',
		     'three_line_alt1_desc_clickable':'<div class="three_line_alt1_desc_clickable"><a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\'" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a><a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\'" target="'+links_google_window_target+'"><span class="desc">##DESC_1## ##DESC_2##</span></a></div>',

		    // ##IMAGE##, ##HEADLINE##, ##DESC_1## ##DESC_2##, ##DISPLAY_URL##
		     'afc_images_three_line':'<a track="##WSS##" href="##URL##" class="image" target="'+links_google_window_target+'">##IMAGE##</a><a track="##WSS##" href="##URL##" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><span class="desc">##DESC_1## ##DESC_2##</span><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a></div>',

		    // ##HEADLINE##, ##DESC_1## ##DESC_2##, ##SELLER_RATINGS##, ##DISPLAY_URL##
		     'seller_ratings':'<div class="seller_rating"><a track="##WSS##" href="##URL##" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><span class="desc">##DESC_1## ##DESC_2##</span><span class="seller_ratings">##SELLER_RATINGS##</span><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a></div>',

		    // ##HEADLINE##, ##DESC_1## ##DESC_2##, ##SELLER_RATINGS##, ##DISPLAY_URL##
		     'seller_ratings_alt1':'<div class="seller_rating alt1"><a track="##WSS##" href="##URL##" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><span class="desc">##DESC_1## ##DESC_2##</span><span class="seller_ratings">##SELLER_RATINGS##</span><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a></div>',

		    // ##HEADLINE##, ##DISPLAY_URL##, ##DESC_1## ##DESC_2##, ##SELLER_RATINGS##
		     'seller_ratings_alt2':'<div class="seller_rating alt2"><a track="##WSS##" href="##URL##" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a><span class="desc">##DESC_1## ##DESC_2##</span><span class="seller_ratings">##SELLER_RATINGS##</span></div>',

		    // ##HEADLINE##, ##DESC_1## ##DESC_2##, ##DISPLAY_URL##, ##SITE_LINKS##
		     'site_links':'<div class="site_links"><a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\';return true;" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><span class="desc">##DESC_1## ##DESC_2##</span><a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\';return true;" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a>##SITE_LINKS##</div>',

		    // ##HEADLINE##, ##DISPLAY_URL##, ##DESC_1## ##DESC_2##, ##SITE_LINKS##
		     'site_links_alt1':'<div class="site_links alt1"><a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\';return true;" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><a track="##WSS##" href="##URL##" onclick="this.href=\'##TRACK_URL##\';return true;" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a><span class="desc">##DESC_1## ##DESC_2##</span>##SITE_LINKS##</div>',

		    // ##HEADLINE##, ##DESC_1## ##DESC_2##, ##DISPLAY_URL##, ##SELLER_RATINGS##, ##SITE_LINKS##
		     'sr_and_sl':'<div class="seller_rating site_links"><a track="##WSS##" href="##URL##" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><span class="desc">##DESC_1## ##DESC_2##</span><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a><br /><span class="seller_ratings">##SELLER_RATINGS##</span>##SITE_LINKS##</div>',

			// ##HEADLINE##, ##DISPLAY_URL##, ##DESC_1## ##DESC_2##, ##SITE_LINKS##, ##SELLER_RATINGS##
			 'sr_and_sl_alt1':'<div class="seller_rating site_links alt1"><a track="##WSS##" href="##URL##" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a><span class="desc">##DESC_1## ##DESC_2##</span>##SITE_LINKS##<span class="seller_ratings">##SELLER_RATINGS##</span></div>',

			// ##HEADLINE##, ##DISPLAY_URL##, ##DESC_1## ##DESC_2##, ##SELLER_RATINGS##, ##SITE_LINKS##
			 'sr_and_sl_alt2':'<div class="seller_rating site_links alt2"><a track="##WSS##" href="##URL##" class="headline" target="'+links_google_window_target+'">##HEADLINE##</a><a track="##WSS##" href="##URL##" class="site adUnitLink" target="'+links_google_window_target+'">##DISPLAY_URL##</a><span class="desc">##DESC_1## ##DESC_2##</span><span class="seller_ratings">##SELLER_RATINGS##</span>##SITE_LINKS##</div>'
		...
		layouts:{
			afc:'two_line',
			afcimages:'afc_images_three_line',
			afs:'three_line',
		...
		draw_ads: function(ads, type, g_info) {
			...
			this.meta[type] = g_info;
			this.ads[type] = ads;
			if(this.page_type=="ra_topic" && type!="radlinks")
				this.set_noads_in_first_ds(ads);
			var x;
			for(var n = 0; n < ads.length; n++) {
				print_debug(ads[n]);
				var unit_html = get_unit_html(this.get_layout(type, ads[n]), ads[n], n);
				if(unit_html) {
					x = n;
					if(this.page_type=="ra_topic" && type!="radlinks" && this.noads_in_first_ds){
						x = n + parseInt(this.ads_on_first_ds);
					}
					this.write_unit(type, x, unit_html);
				}
				else {
		...
		write_unit: function(type, n, unit_html, count) {
			...
			if(block) {
				...
				adsnip_click(new_ad, type, this.ads[type][n]);
				return true;
			} else if (document.readyState !== "complete" || count < 10) {
				count++;
				setTimeout(function() {
					var delayedwrite = function(type, n, unit_html, count) { this.write_unit(type, n, unit_html, count); };
					delayedwrite.apply(obj, new Array(type, n, unit_html, count));
				}, 100);
			}
		...
		set_ads_on_first_ds: function(n){
			this.ads_on_first_ds = n;
		},
		set_noads_in_first_ds: function(g_ads){
			var gads = g_ads.length;
			if(gads > 0){
				if(g_ads[0].visible_url.toLowerCase().indexOf('ebay')>=0 || g_ads[0].visible_url.toLowerCase().indexOf('starware')>=0 || g_ads[0].visible_url.toLowerCase().indexOf('heliumknowledge')>=0 || g_ads[0].visible_url.toLowerCase().indexOf('sites')>=0 || g_ads[0].visible_url.toLowerCase().indexOf('KeepMedia')>=0 || g_ads[0].visible_url.toLowerCase().indexOf('8')>=0 || g_ads[0].visible_url.toLowerCase().indexOf('10')>=0 || g_ads[0].visible_url.toLowerCase().indexOf('target')>=0 || g_ads[0].visible_url.toLowerCase().indexOf('local')>=0 )
					this.noads_in_first_ds = true;
				else
					this.noads_in_first_ds = typeof g_ads[0].is_commercial!="undefined" && g_ads[0].is_commercial!="";
			}
		},

		set_add_adinfo: function(n){
			if(!n) {
				this.add_adinfo = false;
			}
		},
		...
		get_layout:function(type, ad){
			...
			var layout = type;
			if(type == 'afc'){
				print_debug("Setting to current AFC layout: "+ this.layouts.afc);
				layout = this.layouts.afc;
			}
			if(type == 'afcimages'){
				print_debug("Setting to current AFCImage layout: "+ this.layouts.afcimages);
				layout = this.layouts.afcimages;
			}
			if(type == 'afs'){
				print_debug("Setting to current AFS layout: "+ this.layouts.afs);
				layout = this.layouts.afs;
			}
			if(typeof ad.seller_ratings!="undefined"){
				print_debug("Setting to current Seller Ratings layout: "+ this.layouts.seller_ratings);
				layout = this.layouts.seller_ratings;
			}
			if(typeof ad.site_links!="undefined"){
				print_debug("Setting to current Site Links layout: "+ this.layouts.site_links);
				layout = this.layouts.site_links;
			}
			if(typeof ad.seller_ratings!="undefined" && typeof ad.site_links!="undefined"){
				print_debug("Setting to current SR and SL layout: "+ this.layouts.sr_and_sl);
				layout = this.layouts.sr_and_sl;
			}
	...
	if ("undefined" != typeof url && "undefined" == typeof this.includes[url]) {
		...
		var xhr = jQuery.ajax({
			...
			error: function(xhr, status, ex) {
				console && console.log("jsInclude AJAX Error url:" + url + "\nstatus:" + status + "\nresponse:" + xhr.responseText);
			},
			dataType: dataType,
			cache: true
		});
...
AjaxResponse.prototype.addCssInclude = function(url, checkCallback) {
	...
	if ("text" == dataType) {
		var xhr = jQuery.ajax({
			...
			error: function(xhr, status, ex) {
				console && console.log("cssInclude AJAX Error:" + "\nurl:" + url + "\nstatus:" + status + "\nresponse:" + xhr.responseText);
			}
		});
		this.xhrs.push(xhr);
	} else {
...
AjaxResponse.prototype.jsonErrorCallback = function(xhr, status, ex, error) {
	if ("function" === typeof error) {
		...
		console && console.log("JSON Ajax response error url:" + this.options.url + "\nstatus:" + status + "\nresponse:" + xhr.responseText);
...
AjaxResponse.prototype.syncErrorCallback = function(xhr, status, ex, error) {
	if ("function" === typeof error) {
		...
		console && console.log("SYNC Ajax response error" + "\nurl:" + this.options.url + "\nstatus:" + status + "\nresponse:" + xhr.responseText);
...
MobileAjaxResponse.prototype.jsonErrorCallback = function(xhr, status, ex, error) {
	...
	console && console.log("Oops... we were unable to process your request. Try again later");
	if ("undefined" != typeof modalDialog) {
		modalDialog.hide();
	}
	return {status: "ERROR"};
...
MobileAjaxResponse.prototype.statusALERT = function(data) {
	if ("undefined" != typeof data && "undefined" != typeof data.message) {
		console && console.log("Error: " + data.message);
		if ("undefined" != typeof modalDialog) {
			modalDialog.hide();
		}
	}
...
function windowLoaded() {
	if (typeof windowOnloadArr != "undefined" && !window.loaded!=null) {
		window.loaded = 1;
		for(var i=0,max=windowOnloadArr.length;i<max;i++){
...
jQuery(window).load(function() {
	jQuery(".smallBtn").each(function(){
		...
		// checking to see if jquery ui button method exists
	...
	// allow for white button icons (defined in includes/css/jqueryui.answers.css)
	// we use a timeout here, since a number of .button() calls are made on page load/dom ready
	// any button with a class of .icon-white, gets the white icon images instead
	window.setTimeout(function() {
		$('.ui-button.icon-white span.ui-icon').addClass('ui-icon-white');
	}, 200);
});
...
function draw_on_this_page(dsnameslist){
	...
	jQuery.each(dsnameslist, function(key,val){
		onthispage +='<li><a title="'+key.replace(/_/g," ")+'" id="lhs-'+key+'" onclick="track(\'NP07-P1_OTP\', \''+key.replace(/_/g," ")+'\')" href="#'+val+'_ds">'+key.replace(/_/g," ")+'</a></li>';
	});
	onthispage +='<li><a id="lhs-copyrights" href="#ds_copyrights">Copyrights</a></li>';
...
$.fn.buttonDropshadow = function() {
	var btn_base_width = 118;
	var dropshadow_base_width = 110;
	var dropshadow_base_height = 12;
	var bulge_diff = 0.2;
	var fudge = 0.25
	this.each(function(i, obj) {
		jObj = jQuery(obj);
		var btn_width = Math.floor(jObj.outerWidth(true));
		var btn_height = Math.floor(jObj.outerHeight(true));
		var dropshadow_width = Math.floor(dropshadow_base_width * btn_width / btn_base_width);
		var dropshadow_height = Math.floor(dropshadow_base_height * dropshadow_width / btn_base_width);
		var btn_pos = jObj.position();
		var dropshadow_left = btn_pos.left + Math.floor((btn_width - dropshadow_width) / 2);
		var dropshadow_top = Math.ceil(btn_pos.top + btn_height - (dropshadow_height - (dropshadow_height * bulge_diff) + fudge));

		jObj.css({"z-index": 990});
		var dropshaddow = jQuery("<img>").attr({
											"src": jwgData.rbxStaticFileServer+"/includes/images/jquery-ui/ui-dropshadow.png"
											, "width": dropshadow_width + "px"
										})
										.css({
											"position": "absolute"
											, "left": dropshadow_left + "px"
											, "z-index": 10
											, "top": dropshadow_top + "px"
										})
										.insertAfter(jObj);
	});
}
...
if (document.all){
	...
	$('title').change(function() {
		...
		doc_title = doc_title.indexOf('#') != -1 ? doc_title.substring(0, doc_title.indexOf('#')) : doc_title;
...
function configure_search(){
	...
	var cur = window.location.host.match(/(online|local|www|wiki)\.answers\.com/);
	switch(cur[1])
	{
		case 'online':
			set_corpus('online');
			set_sites_submit();
			$radios.filter('[value=online]').attr('checked', true);
			break;
		case 'local':
			set_corpus('local');
			set_local_submit();
			$radios.filter('[value=local]').attr('checked', true);
			break;
		default:
			break;
	}
...
function set_local_submit(){
	$('#header_title').html('Find local business...');
	$('.header .finder_business').show();
	$('.search_submit').click(function(e){
		if($('.CategoriesLocal').eq(0).val() == ""){
			return false;
		}
		do_lookup(this);
	});
...
function search_sites(e){

	var searchInput = jQuery(".search_input");
	var searchText = jQuery.trim(searchInput.val());
	if("" != searchText) {
		var domain = (jwgData.config.wgServer=="http://wiki.answers.com" || jwgData.config.wgServer=="http://www.answers.com") ? "http://online.answers.com": jwgData.config.wgServer.replace(/answers\.com/i,"online.answers.com");
		var url =  domain + "/results/" + encodeURIComponent(searchText);
		location.href = url;
	}
}
...
function set_corpus(type) {
	...
	case 'all':
		...
		break;
	case 'wa':
		$('#header_title').html('Enter question...');
		break;
	case 'ra':
		$('#header_title').html('Enter word...');
		break;
	case 'local':
		set_local_submit();
		break;
	case 'online':
		$('#header_title').html('Enter site...');
		set_sites_submit();
		break;
	}
	$('#header_title').css('visibility','visible');
...
jQuery('.links_google .ads li:last-child').addClass('last');

var object_merge = function(original, override){
	var attr;
	for(attr in override){
		if(override.hasOwnProperty(attr)){
			original[attr] = override[attr];
		}
	}
	return original;
};
  ...
  try {
    if (FB && FB.Event && FB.Event.subscribe) {
      FB.Event.subscribe('edge.create', function(opt_target) {
    	params = _ga.getSocialActionTrackers_('facebook', 'like',
                opt_target, opt_pagePath);
        _gaq.push(params);
        if(typeof console != "undefined" && window.location.href.match(/gadebug=1/i) != null) {
            console.log('facebook like: opt_target='+opt_target+' opt_pagePath='+opt_pagePath);
       }
      });
      FB.Event.subscribe('edge.remove', function(opt_target) {
    	params = _ga.getSocialActionTrackers_('facebook', 'unlike',
                opt_target, opt_pagePath);
        _gaq.push(params);
        if(typeof console != "undefined" && window.location.href.match(/gadebug=1/i) != null) {
        	console.log('facebook unlike: opt_target='+opt_target+' opt_pagePath='+opt_pagePath);
       }
      });
      FB.Event.subscribe('message.send', function(opt_target) {
    	params = _ga.getSocialActionTrackers_('facebook', 'send',
                opt_target, opt_pagePath);
        _gaq.push(params);
        if(typeof console != "undefined" && window.location.href.match(/gadebug=1/i) != null) {
        	console.log('facebook send: opt_target='+opt_target+' opt_pagePath='+opt_pagePath);
       }
      });
      FB.Event.subscribe('comment.create', function(targetUrl) {
        _gaq.push(['_trackSocial', 'facebook', 'comment', targetUrl]);
        if(typeof console != "undefined" && window.location.href.match(/gadebug=1/i) != null) {
        	console.log('comment create: _trackSocial facebook comment targetUrl: '+targetUrl);
       }
      });
      FB.Event.subscribe('comment.remove', function(targetUrl) {
        _gaq.push(['_trackSocial', 'facebook', 'uncomment', targetUrl]);
        if(typeof console != "undefined" && window.location.href.match(/gadebug=1/i) != null) {
        	console.log('comment create: _trackSocial facebook uncomment targetUrl: '+targetUrl);
       }
      });
    }
  } catch (e) {
