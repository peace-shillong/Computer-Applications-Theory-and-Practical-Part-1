...
void main()
{
	...
	dcurve(286,120,280,400,700,1,-300,-300);
	dcurve(286,120,280,400,-700,1,-300,1);
	//dcurve(280,120,280,400,-700,-350,300,-300);
	boundaryfill(310,411,14,WHITE);
	//boundaryfill(355,145,2,WHITE);

	//boundaryfill(222,104,2,WHITE);
